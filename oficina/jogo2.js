...
function preload() {
	...
	game.load.spritesheet('jogador', 'assets/dude2.png', 32, 48);
...
function create() {
	...
	ledge = platforms.create(0, 500, 'blocks');
    ledge.body.immovable = true;
	
	ledge = platforms.create(10, 260, 'blocks');
    ledge.body.immovable = true;
	...
	player = game.add.sprite(64, game.world.height - 300, 'jogador');
